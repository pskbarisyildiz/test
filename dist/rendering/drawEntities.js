 ...
 */
export function drawPlayer(ctx, player, hasBall) {
 ...
 */
export function drawPlayerShadow(_ctx, _player, _size) {
 ...
 */
export function drawPlayerBody(ctx, player, size) {
 ...
 */
export function drawPlayerHighlight(ctx, player, size, hasBall) {
    const isShooter = gameState.shooter && gameState.shooter.name === player.name && gameState.shotInProgress;
 ...
 */
export function drawPlayerLabel(ctx, player) {
 ...
 */
export function drawGroundShadow(ctx, x, y, size, ballHeight) {
 ...
 */
export function drawShotEffect(ctx, x, y, size) {
 ...
 */
export function drawBallBody(ctx, x, y, size) {
    // Enhanced 3D ball with realistic shading
    // Main ball gradient for depth
    const mainGradient = ctx.createRadialGradient(x - size * 0.35, y - size * 0.35, size * 0.1, x, y, size);
    ...
    const shadowGradient = ctx.createRadialGradient(x + size * 0.3, y + size * 0.3, 0, x + size * 0.3, y + size * 0.3, size * 0.7);
 ...
 */
export function drawBallPattern(ctx, x, y, size) {
...
//# sourceMappingURL=drawEntities.js.map