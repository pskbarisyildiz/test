...
export function drawPitchBackground() {
    ...
    if (gameState.offscreenPitch) {
        ctx.drawImage(gameState.offscreenPitch, 0, 0, // Source X, Y
        GAME_CONFIG.PITCH_WIDTH, GAME_CONFIG.PITCH_HEIGHT, 0, 0, // Destination X, Y (Logical 0, 0)
    ...
    ctx.drawImage(gameState.offscreenPitch, 0, 0, GAME_CONFIG.PITCH_WIDTH, GAME_CONFIG.PITCH_HEIGHT, 0, 0, GAME_CONFIG.PITCH_WIDTH, GAME_CONFIG.PITCH_HEIGHT);
    // -------------------------------------------------------------------
 ...
 */
export function drawStripes(ctx, w, h) {
 ...
 * Draw pitch lines
 */
export function drawLines(ctx, w, h) {
 ...
 * Draw center circle
 */
export function drawCenterCircle(ctx, w, h) {
    ctx.save();
    ctx.shadowColor = 'rgba(255, 255, 255, 0.9)';
    ctx.shadowBlur = 10;
    ctx.strokeStyle = '#ffffff';
 ...
 * Draw goals
 */
export function drawGoals(ctx, w, h) {
    ctx.save();
 ...
 */
export function drawPenaltyAreas(ctx, w, h) {
    ctx.save();
    ctx.shadowColor = 'rgba(255, 255, 255, 0.8)';
    ctx.shadowBlur = 8;
    ctx.strokeStyle = '#ffffff';
...
//# sourceMappingURL=drawPitch.js.map