...
export function renderStats() {
    ...
    return `
        <div style="
            ...
            align-items: center;
        ">
            ${createStatBar('Possession', `${homeStats.possession || 50}%`, `${awayStats.possession || 50}%`, homePossessionPercent, awayPossessionPercent, gameState.homeJerseyColor, gameState.awayJerseyColor)}

            ${createStatBar('Shots', homeShots, awayShots, homeShotsPercent, awayShotsPercent, gameState.homeJerseyColor, gameState.awayJerseyColor)}

            ${createStatBar('xG', (homeStats.xGTotal || 0).toFixed(2), (awayStats.xGTotal || 0).toFixed(2), homeXGPercent, awayXGPercent, gameState.homeJerseyColor, gameState.awayJerseyColor)}
        </div>
    `;
}
// ============================================================================
        ...
        return `
            ...
            ">
                ...
                ">
                    <div style="
                        width: ${homePercent}%;
                        background: linear-gradient(90deg, ${gameState.homeJerseyColor}, ${lightenColor(gameState.homeJerseyColor, 20)});
                        transition: width 0.5s cubic-bezier(0.4, 0, 0.2, 1);
                        box-shadow: 0 0 8px ${gameState.homeJerseyColor}60;
                    "></div>
                    <div style="
                        width: ${awayPercent}%;
                        background: linear-gradient(270deg, ${gameState.awayJerseyColor}, ${lightenColor(gameState.awayJerseyColor, 20)});
                        transition: width 0.5s cubic-bezier(0.4, 0, 0.2, 1);
    ...
    return `
        <div style="padding: 20px 0;">
            ...
            ">
                ...
                ${renderStatBar('Offsides', homeStats.offsides || 0, awayStats.offsides || 0, '🚩')}
            </div>
        </div>
    `;
}
...
// ============================================================================
export function switchSummaryTab(tab) {
