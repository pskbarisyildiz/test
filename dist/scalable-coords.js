...
export class RelativePosition {
    ...
    lerp(other, t) {
        return new RelativePosition(this.rx + (other.rx - this.rx) * t, this.ry + (other.ry - this.ry) * t);
    }
}
...
export class PlayerPositionManager {
    ...
    moveToward(targetRelPos, deltaTime, speedMultiplier = 1.0) {
        const maxSpeed = FIELD_CONFIG.speedToPixelsPerSecond(this.player.pace / 100 * 10) * speedMultiplier;
        ...
        const currentSpeed = Math.sqrt(this.velocity.rx * this.velocity.rx +
...
export function initializePlayerPosition(player, formationPos) {
...
export function isInAttackingThird(player, isHome) {
...
export function setFieldScale(newScale) {
...
//# sourceMappingURL=scalable-coords.js.map