...
// ============================================================================
export const positionToRoleMap = {
    // Goalkeepers
    'Goalkeeper': 'GK',
    'Keeper': 'GK',
    // Defenders
 ...
 */
export function getRoleFromPosition(positionString) {
    if (!positionString)
        return 'CM'; // Default role
...
// ============================================================================
export const TEAM_STATE_MODIFIERS = {
    ATTACKING: {
 ...
 */
export function validatePhysicsRealism() {
