 ...
 */
export function updateBallTrajectory(_dt) {
 ...
 */
export function validateBallState() {
    // Validate position
    ...
    const speed = Math.sqrt(gameState.ballVelocity.x * gameState.ballVelocity.x +
 ...
 */
export function validateBallHolder(player) {
    if (!player)
        return null;
 ...
 */
export function updateBallWithHolder(allPlayers, dt) {
    ...
    if (holder && allPlayers.includes(holder)) {
        ...
        const currentSpeed = Math.sqrt(gameState.ballVelocity.x * gameState.ballVelocity.x +
            gameState.ballVelocity.y * gameState.ballVelocity.y);
        // Apply friction
 ...
 */
export function updatePlayerPhysics(allPlayers, dt) {
 ...
 */
export function assignBallChasers(allPlayers, priorityChaser = null) {
