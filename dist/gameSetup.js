 ...
 */
export function getFormationPosition(player, team, _formation, gameState) {
 ...
 */
export function applyFormationConstraint(player, team, formation, gameState) {
...
export function getFormationPositions(isHome, isSecondHalf, formationName) {
...
// ============================================================================
export function initializePlayers(home, away, homeFormation, awayFormation) {
...
function calculateFormationScore(positionCounts, required, avgQualities) {
    ...
    const availabilityScore = ((Math.min(positionCounts.defenders / reqDef, 1) +
...
export function selectBestFormation(teamPlayers) {
...
// TACTIC SELECTION
// ============================================================================
export function selectBestTactic(teamPlayers) {
...
export function selectBestTeam(teamName) {
