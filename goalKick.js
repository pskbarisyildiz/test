...
function getFormationAnchorForPlayer(player, gameState) {
    ...
    if (typeof window !== 'undefined' && typeof window.getPlayerActivePosition === 'function') {
        return window.getPlayerActivePosition(player, currentHalf);
    }
...
const ProfessionalGoalKickBehaviors = {
    getGoalKickPosition(player, ownGoalX, tactic, playShort, gameState, teammates) {
        ...
        if (!gameState._goalKickPosManager) gameState._goalKickPosManager = new PositionManager();
    ...
    getDefendingGoalKickPosition(player, opponentGoalX, ownGoalX, gameState, opponents, teammates) {
        ...
        if (!gameState._goalKickDefPosManager) gameState._goalKickDefPosManager = new PositionManager();
