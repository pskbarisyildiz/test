...
// ============================================================================
const ProfessionalFreeKickBehaviors = {
    getAttackingFreeKickPosition(player, fkPos, opponentGoalX, distToGoal, sortedLists, gameState, teammates) {
        ...
        if (!gameState._fkAttPosManager) gameState._fkAttPosManager = new PositionManager();
    ...
    getDefendingFreeKickPosition(player, fkPos, ownGoalX, distToGoal, sortedLists, opponents, gameState, teammates) {
        ...
        if (!gameState._fkDefPosManager) gameState._fkDefPosManager = new PositionManager();
        ...
        if (myPositionData) {
            ...
            // Encroachment rule
            const dist = window.getDistance({ x: finalPos.x, y: finalPos.y }, fkPos);
    ...
    calculateWallPosition(positionData, wallSize, fkPos, ownGoalX, direction, player, gameState) {
        try {
            const wallIndex = positionData.wallIndex ?? parseInt(positionData.role.split('_')[2]);
