...
function enforceKickOffHalfRule(player, gameState) {
    ...
    const centerX = (typeof GAME_CONFIG !== 'undefined' && GAME_CONFIG.PITCH_WIDTH)
        ? GAME_CONFIG.PITCH_WIDTH / 2
        : 400;

    // Determine own goal position
    const ownGoalX = window.getAttackingGoalX
